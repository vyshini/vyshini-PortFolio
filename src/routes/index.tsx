...
const ibmInternshipCert = { url: "/certifications/ibm-internship.jpg" };
const googleCloudCert = { url: "/certifications/googlecloud.jpg" };
const ibmAiCert = { url: "/certifications/ibm-ai.jpg" };
