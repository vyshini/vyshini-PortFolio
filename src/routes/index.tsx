...
import hackverseUrl from "@/assets/certs/hackverse.jpg";
import cidecodeUrl from "@/assets/certs/cidecode.jpeg";
import mongodbUrl from "@/assets/certs/mongodb.jpg";
import ibmInternshipUrl from "@/assets/certs/ibm-internship.jpg";
import googleCloudUrl from "@/assets/certs/googlecloud.jpg";
import ibmAiUrl from "@/assets/certs/ibm-ai.jpg";
import nptelUrl from "@/assets/certs/nptel.jpg";
import genaiDalleUrl from "@/assets/certs/genai-dalle.jpg";
import genaiPythonUrl from "@/assets/certs/genai-python.jpg";
const hackverseCert = { url: hackverseUrl };
const cidecodeCert = { url: cidecodeUrl };
const mongodbCert = { url: mongodbUrl };
const ibmInternshipCert = { url: ibmInternshipUrl };
const googleCloudCert = { url: googleCloudUrl };
const ibmAiCert = { url: ibmAiUrl };
const nptelCert = { url: nptelUrl };
const genaiDalleCert = { url: genaiDalleUrl };
const genaiPythonCert = { url: genaiPythonUrl };
